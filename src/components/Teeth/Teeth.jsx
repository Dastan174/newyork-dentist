...
//   }, []);
  ...
  // Контент слайдов
  const slidesContent = [
    { title: "Имплантация зубов" , price: "от 18 000 ₽", description: "По новой прогрессивной методике" },
    { title: "Сертификаты со скидкой" , price: "от 18 000 ₽", description: "По новой прогрессивной методике" },
    { title: "Новые услуги" , price: "от 18 000 ₽", description: "По новой прогрессивной методике" },
    { title: "Бесплатная консультация" , price: "от 18 000 ₽", description: "По новой прогрессивной методике" },
  ];
